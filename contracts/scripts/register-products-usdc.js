...
async function main() {
  const productRegistryAddress = "0x0AA169680b5AAe296Fc8634C28B2a86ddb99f300";
  ...
  console.log("\n=== Registering Products (USDC System) ===");
  ...
  console.log("✓ Products registered successfully in USDC system!");
}
